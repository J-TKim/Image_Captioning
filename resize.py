...
def resize_image(image, size):
    """Resize am image to the given size"""
    return image.resize(size, Image.ANTIALIS)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='./data/train_2014/', help='directory for train images')
